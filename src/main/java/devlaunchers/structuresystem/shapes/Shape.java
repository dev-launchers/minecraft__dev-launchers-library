...
public abstract class Shape {
  ...
  public Location transformLocation(int relativeX, int relativeY, int relativeZ) {
    ...
    if (parent == null) {
      ...
      originalLocation =
          originalLocation.add(xOffset + relativeX, yOffset + relativeY, zOffset + relativeZ);
    } else {
      originalLocation =
          parent.transformLocation(xOffset + relativeX, yOffset + relativeY, zOffset + relativeZ);
    ...
    if (hasLocationTransformer()) {
      return getLocationTransformer()
          .transformLocation(
              new LocationTransformationRequest(
                  originalLocation, xOffset + relativeX, yOffset + relativeY, zOffset + relativeZ));
    }
  ...
  /**
   * Adds a Filter Transformation, which allows cutting off Shapes (for example only lower half of a
   * Sphere etc.)
   *
   * @param filter
